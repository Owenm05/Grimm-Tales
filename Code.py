...
def choice2():
print("You go east\n north of you you see a village \n to the northwest you see a forest and to
the northeast you see a graveyard\n")
...
village=input("as you enter the village one establishment stands out to you, the inn do you
want to enter the inn?\n")
